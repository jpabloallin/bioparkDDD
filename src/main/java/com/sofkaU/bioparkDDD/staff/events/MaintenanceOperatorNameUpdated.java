...
public class MaintenanceOperatorNameUpdated extends DomainEvent {
    private final MaintenanceOperatorId entityId;
    private final Name name;

    public MaintenanceOperatorNameUpdated(MaintenanceOperatorId entityId, Name name) {
        super("biopark.staff.maintenanceoperatornameupdated");
